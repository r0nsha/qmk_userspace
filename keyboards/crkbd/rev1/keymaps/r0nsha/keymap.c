...
enum layers { QWERTY, COLEMAK, GAMING, EXT, SYM, NUM, FUN, MOUSE };

static const hsv_t layer_colors[] = {
    [QWERTY] = {HSV_ORANGE}, [COLEMAK] = {HSV_MAGENTA}, [GAMING] = {HSV_RED}, [EXT] = {HSV_CHARTREUSE}, [SYM] = {HSV_SPRINGGREEN}, [NUM] = {HSV_BLUE}, [FUN] = {HSV_PURPLE}, [MOUSE] = {HSV_CYAN},
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY] = LAYOUT_split_3x6_3(
        ...
        TD(TD_COLEMAK), KC_Z,         KC_X,         KC_C,            KC_V,            KC_B,              KC_N,   KC_M,             KC_COMM,      KC_DOT,       KC_SLSH,          TD(TD_GAMING),
                                                    LT(NUM, KC_ESC), LT(EXT, KC_SPC), LT(MOUSE, KC_TAB), KC_ENT, LT(SYM, KC_BSPC), MO(FUN)
    ),
...
void oled_render_layer(void) {
    static const char *layer_names[] = {
        [QWERTY] = "QWERTY", [COLEMAK] = "COLEMAK", [GAMING] = "GAMING", [EXT] = "EXT", [SYM] = "SYM", [NUM] = "NUM", [FUN] = "FUN", [MOUSE] = "MOUSE",
    };
