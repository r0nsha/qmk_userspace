...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FUN] = LAYOUT_split_3x6_3(
        RM_TOGG, XXXXXXX, XXXXXXX, KC_MSTP, KC_PSCR, XXXXXXX, XXXXXXX, KC_F12,  KC_F7,  KC_F8, KC_F9, QK_BOOT,
        RM_NEXT, XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, KC_BRIU, XXXXXXX, KC_F11,  KC_F4,  KC_F5, KC_F6, QK_RBT,
        RM_PREV, XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, KC_BRID, XXXXXXX, KC_F10,  KC_F1,  KC_F2, KC_F3, EE_CLR,
                                   _______, _______, _______, _______, _______, _______
    ),
};
